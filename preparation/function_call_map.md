...
create_new_patient_record(first_name="Alice", last_name="Brown", date_of_birth="1990-01-10", phone="555-0110", email="alice.brown@email.com", insurance="Aetna", address_zip="12346", provider="Dr. Chen")
escalate_to_staff(patient_id="P001", priority="emergency", message="Patient showing critical symptoms")
